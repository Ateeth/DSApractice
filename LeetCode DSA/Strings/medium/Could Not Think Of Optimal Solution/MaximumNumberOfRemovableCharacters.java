...
public class MaximumNumberOfRemovableCharacters {
    public static int maximumRemovals(String s, String p, int[] removable) {
        ...
        // The left boundary represents the lower limit (0 at first) while the right boundary represents the upper limit
        // (the length of the removable array)
        // Each time, I find the middle number (which is an attempt to remove that number of letters from the string)
        // I also use an array of characters and replace those letters removed with the '/' symbol (can choose anything
        // as long as it's a non-letter)
        // This should be faster and more convenient to work with as compared to removing letters directly from a string
        // (high time complexity from string concatenation)
    ...
    //I use two-pointers to keep track of which char I'm looking at now in the char array, and another to keep track of
    // which char I'm looking at in p.
    // If the character wasn't 'removed' (remember this is indicated by the '/' symbol) and the characters are equal, I
    ...
    public static void main(String[] args){
        ...
        System.out.println("Enter the size of removable characters array : ");
        int n = sc.nextInt() ;
        ...
        int ans = maximumRemovals(str , str1 , removable) ;
