...
package com.ateeth.LeetCodeDSA.searching.medium.CouldNotUnderstandSolutionVeryWell;
...
public class MaximumValueAtAGivenIndexInABoundedArray {
    ...
    public static int calcAns(int max, int idx, int n) {
        ...
        long ret = calcPart(max - 1, idx) + calcPart(max, n - idx); //left half of array + right half of array
        if(ret > 1000000000) {
    ...
    public static long calcPart(int a, int num) {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Enter the value of maxSum : ");
